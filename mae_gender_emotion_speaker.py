...
EMO_ENC = tf.keras.models.load_model('./models/mae_encoder_gender_and_emotion')
...
log_dir = "./logs/mae_gender_emotion_speaker/" + time
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
csv_logger = CSVLogger('./logs/mae_gender_emotion_speaker.csv', append=True, separator=',')
...
mae_encoder.save('./models/mae_encoder_gender_emotion_speaker')
