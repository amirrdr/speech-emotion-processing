...
log_dir = "./logs/mae/mae_emotion_and_gender/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
csv_logger = CSVLogger('./logs/mae/mae_emotion_and_gender.csv', append=True, separator=',')
...
mae_encoder.save('./models/mae_encoder_emotion_and_gender')
