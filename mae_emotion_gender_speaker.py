...
EMO_ENC = tf.keras.models.load_model('./models/mae_encoder_emotion_and_gender')
...
log_dir = "./logs/mae/mae_emotion_gender_speaker/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
csv_logger = CSVLogger('./logs/mae/mae_emotion_gender_speaker.csv', append=True, separator=',')
...
mae_encoder.save('./models/mae_encoder_emotion_gender_speaker')
