...
input_1 = np.squeeze(data[0])
input_2 = np.squeeze(data[1])
print(input_1.shape)
print(input_2.shape)
...
log_dir = "./logs/mae_gender/" + time
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
csv_logger = CSVLogger('./logs/mae_gender.csv', append=True, separator=',')
...
mae_encoder.save('./models/mae_encoder_gender')
