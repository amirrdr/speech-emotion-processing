...
data = np.load('./data/for_mae/mae_speaker.npy')
data = data[1:, :, :, :]
...
EMO_ENC = tf.keras.models.load_model('./models/mae_encoder_emotion')
...
mae.summary()
# plot_model(mae, to_file='./figures/mae_speaker_and_speaker.png', show_shapes=True, show_layer_names=True)
...
log_dir = "./logs/mae/mae_speaker_and_emotion/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
csv_logger = CSVLogger('./logs/mae/mae_speaker_and_emotion.csv', append=True, separator=',')
...
mae_encoder.save('./models/mae_encoder_speaker_and_emotion')
