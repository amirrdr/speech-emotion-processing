...
EMO_ENC = tf.keras.models.load_model('./models/mae_encoder_speaker_and_emotion')
...
log_dir = "./logs/mae/mae_speaker_emotion_gender/"
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)
csv_logger = CSVLogger('./logs/mae/mae_speaker_emotion_gender.csv', append=True, separator=',')
...
mae_encoder.save('./models/mae_encoder_speaker_emotion_gender')
